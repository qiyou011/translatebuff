...
[Sitio oficial][website] · [Tutorial][docs-tutorial] · [Blog][blog]
...
Tanto si eres usuario como desarrollador, Translatebuff puede ser una parte importante de ese camino. El proyecto sigue en desarrollo activo y agradecemos cualquier comentario o feedback.

### Descarga

> Las páginas en las tiendas de extensiones llegarán pronto. Por ahora, consigue Translatebuff desde el sitio oficial: **[translatebuff.cn][website]**

| Navegador | Descarga                 |
| --------- | ------------------------ |
| Chrome    | [Sitio oficial][website] |
| Edge      | [Sitio oficial][website] |
| Firefox   | [Sitio oficial][website] |

### Comunidad

| [![WeChat badge][wechat-shield-badge]][wechat-link] | Si estás en China continental, puedes unirte al grupo de WeChat. |
| :-------------------------------------------------- | :--------------------------------------------------------------- |
...
2. Reporta issues y envía feedback.
3. Contribuye con código.

### Contribuir con código

Consulta la [guía de contribución][docs-tutorial] para más detalles.
