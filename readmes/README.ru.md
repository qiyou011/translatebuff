...
- [✨ Возможности](#-возможности)
  ...
  - [🤖 20+ AI-провайдеров](#-20-ai-провайдеров)
- [🤝 Участие](#-участие)
- [📜 Коммерческая лицензия](#-коммерческая-лицензия)
- [❤️ Спонсоры](#️-спонсоры)
...
| Браузер | Версия                                                                 | Скачать                                                                     |
| ------- | ---------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| Chrome  | [![Chrome Version badge][chrome-version-shield]][chrome-store-link]    | [Chrome Web Store][chrome-store-link] или [китайское зеркало][crxsoso-link] |
...
| [![Discord badge][discord-shield-badge]][discord-link] | Задавайте вопросы и общайтесь с разработчиками в Discord.                     |
| :----------------------------------------------------- | :---------------------------------------------------------------------------- |
...
Начните со встроенных шаблонов **Словарь** и **Улучшение текста** либо создайте действие с нуля. Структурированные результаты можно сопоставить с полями Notebase и сохранить для дальнейшего изучения.

### 🧠 [Карточки и интервальное повторение][docs-tutorial]
...
### 🤖 [20+ AI-провайдеров][docs-tutorial]

Подключайтесь к 20+ AI-провайдерам через Vercel AI SDK: OpenAI, DeepSeek, Anthropic Claude, Google Gemini, xAI Grok, Groq, Mistral, Ollama и другим. Для каждого можно настроить endpoint, API key и модель.

Также доступны бесплатные варианты: Google Translate, Microsoft Translate и DeepLX для базового перевода без затрат.
...
Структура проекта: [DeepWiki](https://deepwiki.com/mengxi-ream/read-frog)
...
<img src="../assets/tabbit.avif" alt="Tabbit" height="20" /> **Meituan Tabbit Browser Team**: бесплатная лицензия для коммерческого использования в закрытом коде, ограниченная версиями v1.21.3 и ниже (commit [`724863f`](https://github.com/mengxi-ream/read-frog/commit/724863fdbc2d777766cada6c111235534ee03ca0)). Предоставлена 3 марта 2026 года, 9:00 AM по времени Ванкувера (UTC-8).

## ❤️ Спонсоры

Каждое пожертвование помогает нам создавать лучший опыт изучения языков. Спасибо за поддержку нашей миссии.
