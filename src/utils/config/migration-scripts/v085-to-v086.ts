...
export function migrate(oldConfig: any): any {
  ...
  const selectionToolbar =
    oldConfig.selectionToolbar && typeof oldConfig.selectionToolbar === "object"
  ...
  return {
    ...
    selectionToolbar: {
      ...selectionToolbar,
      saveSuggestion: selectionToolbar.saveSuggestion ?? { enabled: true },
      ...(Array.isArray(customActions) ? { customActions: customActions.map(repairAction) } : {}),
    },
  }
}
