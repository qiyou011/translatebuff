import { BATCH_SEPARATOR, isNoTranslationSentinel } from "@/utils/constants/prompt"

export function canCacheInlineAtomTranslation(source: string, result: string): boolean {
  return (
