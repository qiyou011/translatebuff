// 换皮：上游 popup/components/language-options-selector.tsx 的精确副本，只改布局宽度。
// 上游给两个语言选择器写死 w-30(120px)，容器又是 justify-between —— popup 加宽后
// 剩余空间全塞进中间变成大片留白。改成 flex-1 均分，中间只留 gap。
...
const langSelectorTriggerClasses =
  "!h-14 min-w-0 flex-1 rounded-lg shadow-xs pr-2 gap-1 justify-between bg-transparent"
...
export default function LanguageOptionsSelector() {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <Icon icon="tabler:arrow-right" className="size-4 shrink-0 text-neutral-500" />
      <Combobox
