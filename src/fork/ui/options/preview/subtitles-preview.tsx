...
import { ShadowPreviewFrame } from "@/entrypoints/options/pages/video-subtitles/subtitles-style/style-editor/shadow-preview-frame"
import {
  MainSubtitle,
  TranslationSubtitle,
...
export function SubtitlesPreview({ previewCSS }: SubtitlesPreviewProps) {
  ...
  const sampleTranslation = getPreviewSample().text
